...
class WC_POS_Admin_Menu {
	...
	public function admin_menu() {
		...
		// TODO: Replace data svg with new logo.
		$this->toplevel_screen_id = add_menu_page(
			__( 'POS', 'arcane-woocommerce-pos' ),
			__( 'POS', 'arcane-woocommerce-pos' ),
			'manage_woocommerce_pos',
			WC_POS_PLUGIN_NAME,
			array(new WC_POS_Admin_Settings(), 'display_settings_page'), // This will be replaced later.
		...
		add_submenu_page(
			WC_POS_PLUGIN_NAME,
			__( 'View POS', 'arcane-woocommerce-pos' ),
			__( 'View POS', 'arcane-woocommerce-pos' ),
			'manage_woocommerce_pos',
			null
		);
