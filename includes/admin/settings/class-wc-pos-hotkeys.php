...
class WC_POS_Admin_Settings_HotKeys extends WC_POS_Admin_Settings_Abstract {
  ...
  public function __construct() {
    $this->id    = 'hotkeys';
    $this->label = _x( 'HotKeys', 'keyboard shortcuts', 'arcane-woocommerce-pos' );
    ...
    $this->labels = array(
      'help'    => __( 'Help screen', 'arcane-woocommerce-pos' ),
      'barcode' => __( 'Barcode search', 'arcane-woocommerce-pos' ),
      'search'  => /* translators: woocommerce */__( 'Search', 'woocommerce' ),
      'new'     => __( 'New order', 'arcane-woocommerce-pos' ),
      'sync'    => __( 'Sync with server', 'arcane-woocommerce-pos' )
    );
  }
