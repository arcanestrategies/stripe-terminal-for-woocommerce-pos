...
<table class="wc_pos-form-table">
  ...
  <tr class="order_status">
    <th scope="row">
      <label for="order_status"><?php _e( 'Completed Order Status', 'arcane-woocommerce-pos' ); ?></label>
      <img title="<?php esc_attr_e( 'Change the default order status for POS sales', 'arcane-woocommerce-pos' ) ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" data-toggle="wc_pos-tooltip">
    </th>
    <td>
  ...
  <tr class="order_emails">
    <th scope="row">
      <?php _e( 'Order Emails', 'arcane-woocommerce-pos' ); ?>
      <img title="<?php esc_attr_e( 'Send WooCommerce notification emails for POS orders', 'arcane-woocommerce-pos' ) ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" data-toggle="wc_pos-tooltip">
    </th>
    <td>
      <input type="checkbox" name="admin_emails" id="admin_emails" />
      <label for="order_emails"><?php _e( 'Enable admin emails', 'arcane-woocommerce-pos' ); ?></label>
      <br>
      <input type="checkbox" name="customer_emails" id="customer_emails" />
      <label for="order_emails"><?php _e( 'Enable customer emails', 'arcane-woocommerce-pos' ); ?></label>
    </td>
  </tr>

  <tr class="receipt_printing">
    <th scope="row">
      <?php _e( 'Receipt Printing', 'arcane-woocommerce-pos' ); ?>
    </th>
    <td>
      <input type="checkbox" name="auto_print_receipt" id="auto_print_receipt" />
      <label for="auto_print_receipt"><?php _e( 'Automatically print receipt after checkout', 'arcane-woocommerce-pos' ); ?></label>
    </td>
  </tr>
...
<p>
  <?php _e( 'Installed gateways are listed below. Drag and drop gateways to control their display order at the Point of Sale. ', 'arcane-woocommerce-pos' ); ?><br>
  <?php _e( 'Payment Gateways enabled here will be available at the Point of Sale. Payment Gateways enabled on the settings page will be available in your Online Store. ', 'arcane-woocommerce-pos' ); ?>
</p>

<p class="update-nag" style="font-size:13px;margin:0;">
  <?php _e( 'It is your responsibility to ensure the security of your customer\'s information. Transmitting credit card or other sensitive information should only be done using a secure connnection.', 'arcane-woocommerce-pos' ); ?>
</p>

<table class="wc_pos-form-table">
  <tr>
    <th scope="row"><?php _e( 'Gateway Display', 'arcane-woocommerce-pos' ) ?></th>
    <td>
      <table class="wc-gateways widefat sortable" cellspacing="0">
        <thead>
          <tr>
            ...
            <th scope="col"><?php _e( 'Online Status', 'arcane-woocommerce-pos' ) ?></th>
            <th scope="col"><?php _e( 'POS Status', 'arcane-woocommerce-pos' ) ?></th>
            <th scope="col"><?php _e( 'POS Settings', 'arcane-woocommerce-pos' ) ?></th>
          ...
          <?php foreach ( $this->load_gateways() as $gateway ) : ?>
            <tr id="gateway_<?php esc_attr_e( $gateway->id ) ?>">
              ...
              <td>
                ...
                <?php else: ?>
                  <span class="status-disabled" data-toggle="wc_pos-tooltip" title="<?php esc_attr_e( 'Upgrade to Pro', 'arcane-woocommerce-pos' ); ?>"></span>
                <?php endif; ?>
              </td>
              <td>
                <?php if ( $gateway->pos ): ?>
...
<table id="tmpl-gateway-settings-modal" style="display:none">
  <tr>
    <th scope="row">
      ...
      <img data-toggle="wc_pos-tooltip" title="<?php _e( 'Payment method title.', 'arcane-woocommerce-pos' ); ?>" src="<?php echo esc_url( WC()->plugin_url() ); ?>/assets/images/help.png" height="16" width="16" />
    </th>
  ...
  <tr>
    <th scope="row">
      ...
      <img data-toggle="wc_pos-tooltip" title="<?php _e( 'Payment method description that will be shown in the POS.', 'arcane-woocommerce-pos' ); ?>" src="<?php echo esc_url( WC()->plugin_url() ); ?>/assets/images/help.png" height="16" width="16" />
    </th>
    <td><textarea id="description" name="description"></textarea></td>
  </tr>
  <tr style="display:none">
    <th scope="row">
      <label for="icon"><?php _e( 'Icon', 'arcane-woocommerce-pos' ); ?></label>
    </th>
    <td>
      <input id="icon" name="icon" type="checkbox" />
      <?php echo _x( 'Show payment gateway icon.', 'POS checkout settings', 'arcane-woocommerce-pos' ); ?>
    </td>
  </tr>
</table>