...
class WC_POS_Activator {
	...
	private function woocommerce_check() {
		...
		if( class_exists( 'WC_POS_Admin_Notices' ) ){
			$message = sprintf(
				__('<strong>WooCommerce POS</strong> requires <a href="%s">WooCommerce %s or higher</a>. Please <a href="%s">install and activate WooCommerce</a>', 'arcane-woocommerce-pos' ),
	...
	private function php_check(){
		...
		if( class_exists( 'WC_POS_Admin_Notices' ) ) {
			$message = sprintf(
				__('<strong>WooCommerce POS</strong> requires PHP %s or higher. Read more information about <a href="%s">how you can update</a>', 'arcane-woocommerce-pos' ),
