...
//      'system_status'         => $this,
  ...
  public function get_print_template() {
    ...
    $template_path_theme = '/arcane-woocommerce-pos/';
...
//  }
  ...
  public function email_receipt() {
    ...
    if( is_object( $order ) ) {
      ...
      $response = array(
        'result' => 'success',
        'message' => __( 'Email sent', 'arcane-woocommerce-pos')
      );
      ...
      $response = array(
        'result' => 'error',
        'message' => __( 'There was an error sending the email', 'arcane-woocommerce-pos')
      );
    }
  ...
  public function send_support_email() {
    ...
    $support    = apply_filters( 'woocommerce_pos_support_email', 'support@arcanestrategies.com' );
  ...
  public function check_ajax_referer(){
    ...
    if(!$pass){
      $result = new WP_Error(
        ...
        __( 'Invalid security nonce', 'arcane-woocommerce-pos' ),
        array( 'status' => 401 )
      );
