...
class WC_POS_Params {
  ...
  public function __construct() {
    ...
    $this->debug           = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG && file_exists( WC_POS_PLUGIN_PATH . 'assets/js/app.build.js' );
  ...
  private function product_tabs() {
    return array(
      ...
      'onsale' => array(
        'label' => _x( 'On Sale', 'Product tab: \'On Sale\' products', 'arcane-woocommerce-pos'),
        'id' => 'on_sale:true'
      ),
    );
  }
  ...
  private function menu() {
    ...
    return apply_filters( 'woocommerce_pos_menu', array(
      array(
        'id'     => 'pos',
        'label'  => __( 'POS', 'arcane-woocommerce-pos' ),
        'href'   => '#'
      ),
      array(
        'id'     => 'products',
