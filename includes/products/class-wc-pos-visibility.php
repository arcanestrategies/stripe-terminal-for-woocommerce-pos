...
class WC_POS_Products_Visibility {
  ...
  public function __construct() {
    ...
    // visibility options
    $this->options = array(
      ''            => __( 'POS & Online', 'arcane-woocommerce-pos' ),
      'pos_only'    => __( 'POS Only', 'arcane-woocommerce-pos' ),
      'online_only' => __( 'Online Only', 'arcane-woocommerce-pos' )
    );
  ...
  public function pos_visibility_filters( $views ) {
    ...
    $visibility_filters = array(
      // 'pos_and_online' => __( 'POS & Online', 'arcane-woocommerce-pos' ),
      'pos_only' => __( 'POS Only', 'arcane-woocommerce-pos' ),
      'online_only' => __( 'Online Only', 'arcane-woocommerce-pos' )
    );
  ...
  public function admin_enqueue_scripts( $hook ) {
    ...
    if(defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG && file_exists( WC_POS_PLUGIN_PATH . 'assets/js/src/products.js' )){
