...
<li class="list-row">
  <div class="label"><?php _e( 'Message', 'arcane-woocommerce-pos' ); ?>:</div>
  <div class="input" data-name="message" placeholder="<?php _e('Describe your problem here ...', 'arcane-woocommerce-pos') ?>" contenteditable></div>
</li>
<li class="list-row no-border">
  <div>
    <label class="c-input c-checkbox small">
      ...
      <?php _e( 'Append POS system report', 'arcane-woocommerce-pos' ); ?>
    </label>
